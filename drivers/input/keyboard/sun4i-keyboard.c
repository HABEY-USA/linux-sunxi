...
{
    0,0,0,0,0,0, //key 1, 6个， 0-0.1875V           capture piont 0V
    9,9,9,9,     
    1,1,1,1,1,1,1, //key 2, 11个， 0.34375 -0.53125V   capture piont 0.45V
    9,9,9,9,          
	  2,2,2,2,2,2, //key 3, 12个， 0.6875-0.84375V       capture piont 0.75V
	  9,9,9, 
	  3,3,3,3,3,3, //key 4, 9个，    0.9375-1.125         capture piont 1.05V
	  9,9,9,			   
	  4,4,4,4,4,4,4, //key 5, 5个，  1.25-1.4375            capture piont 1.35V
	  9,9,9,9,
	  5,5,5,5,5,5,5,5, //key 6, 6个， 1.5625-1.7825         capture piont 1.65V
	  9,9,9,9,9,9,9
